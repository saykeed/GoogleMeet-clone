...
export default {
    setup(props, { emit }) {
        const links = ref([
            {text: 'Get a meeting link to share', route: '/', icon: 'settings'},
            {text: 'Start an instant meeting', route: '/gallery', icon: 'info'},
            {text: 'Schedule in Google Calendar', route: '/contact', icon: 'help'}
        ])
...
<style>
    ...
    .createmeet li a:active, li.close:active{
        background: rgba(0, 0, 0, 0.179);
    }

    .createmeet ul li a i, li.close i{
